...
Thanks for helping improve Claudey. Keep changes focused, test the behavior you change, and preserve the public Claude Code and Codex workflows.
...
- Keep shared Anthropic protocol behavior under `src/claudey/core/anthropic/` rather than importing utilities from another provider.
