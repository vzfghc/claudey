...
from claudey.api import request_errors
from claudey.api.handlers import MessagesHandler, TokenCountHandler
from claudey.application import execution
...
def test_stream_ledger_default_debug_has_no_serialized_json_content():
    with patch("claudey.core.anthropic.streaming.emitter.logger.debug") as mock_debug:
...
def test_parse_cli_event_error_logs_metadata_by_default():
    ...
    with patch("claudey.messaging.event_parser.logger.info") as log_info:
        parse_cli_event(
...
def test_count_tokens_unexpected_error_default_logs_exclude_exception_text():
    ...
    from claudey.core.anthropic.models import TokenCountRequest
