...
from claudey.api.optimization_handlers import (
    try_filepath_mock,
    try_optimizations,
...
class TestTryPrefixDetection:
    def test_disabled_returns_none(self):
        ...
        req = _make_request("x")
        with patch(
            "claudey.api.optimization_handlers.is_prefix_detection_request",
    ...
    def test_enabled_and_match_returns_response(self):
        ...
        with (
            ...
            patch(
                "claudey.api.optimization_handlers.extract_command_prefix",
                return_value="/ask",
            ),
            patch("claudey.api.optimization_handlers.logger.info") as mock_log_info,
        ):
...
class TestTryQuotaMock:
    def test_disabled_returns_none(self):
        ...
        with patch(
            "claudey.api.optimization_handlers.is_quota_check_request",
            return_value=True,
        ):
...
class TestTryTitleSkip:
    def test_disabled_returns_none(self):
        ...
        with patch(
            "claudey.api.optimization_handlers.is_title_generation_request",
            return_value=True,
        ):
...
class TestTrySuggestionSkip:
    def test_disabled_returns_none(self):
        ...
        with patch(
            "claudey.api.optimization_handlers.is_suggestion_mode_request",
            return_value=True,
        ):
...
class TestTryFilepathMock:
    def test_disabled_returns_none(self):
        ...
        with patch(
            "claudey.api.optimization_handlers.is_filepath_extraction_request",
    ...
    def test_enabled_and_match_returns_response(self):
        ...
        with (
            ...
            patch(
                "claudey.api.optimization_handlers.extract_filepaths_from_command",
                return_value="a.txt\nb.txt",
            ),
        ):
