...
from claudey.messaging.platforms.discord import (
    DISCORD_AVAILABLE,
    DiscordRuntime,
    _get_discord,
)
from claudey.messaging.platforms.discord_inbound import (
    discord_text_message_from_event,
    parse_allowed_channels,
)
from claudey.messaging.platforms.discord_io import truncate_discord_message
...
class TestGetDiscord:
    ...
    def test_raises_when_discord_not_available(self):
        import claudey.messaging.platforms.discord as discord_mod
...
class TestDiscordRuntime:
    ...
    async def test_send_message_with_reply_to(self):
        ...
        with (
            ...
            patch("claudey.messaging.platforms.discord._get_discord") as mock_get,
        ):
