...
from claudey.providers.stream_recovery import RecoveryHoldbackBuffer
...
async def test_init(provider_config):
    ...
    with patch("claudey.providers.openai_chat.provider.AsyncOpenAI") as mock_openai:
...
async def test_midstream_native_tool_suffix_failure_recovers_without_duplication(
    ...
    with (
        ...
        patch(
            "claudey.providers.stream_recovery.RecoveryHoldbackBuffer",
