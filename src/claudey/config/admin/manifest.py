...
_NON_PROVIDER_FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        default="true",
        description="Open the Admin UI after the next claudey-server launch becomes healthy.",
    ),
    ConfigFieldSpec(
        "MESSAGING_PLATFORM",
        "Messaging Platform",
    ...
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_NVIDIA_NIM",
        "Smoke NVIDIA NIM Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_OPEN_ROUTER",
        "Smoke OpenRouter Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_MISTRAL",
        "Smoke Mistral Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_MISTRAL_CODESTRAL",
        "Smoke Mistral Codestral Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_DEEPSEEK",
        "Smoke DeepSeek Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_LMSTUDIO",
        "Smoke LM Studio Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_LLAMACPP",
        "Smoke llama.cpp Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_OLLAMA",
        "Smoke Ollama Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_OLLAMA_CLOUD",
        "Smoke Ollama Cloud Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_KIMI",
        "Smoke Kimi Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_MINIMAX",
        "Smoke MiniMax Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_WAFER",
        "Smoke Wafer Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_OPENCODE",
        "Smoke OpenCode Zen Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_OPENCODE_GO",
        "Smoke OpenCode Go Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_VERCEL",
        "Smoke Vercel AI Gateway Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_BEDROCK",
        "Smoke Amazon Bedrock Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_HUGGINGFACE",
        "Smoke Hugging Face Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_COHERE",
        "Smoke Cohere Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_GITHUB_MODELS",
        "Smoke GitHub Models Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_ZAI",
        "Smoke Z.ai Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_PECUT",
        "Smoke Pecut Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_FIREWORKS",
        "Smoke Fireworks Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_CLOUDFLARE",
        "Smoke Cloudflare Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_GEMINI",
        "Smoke Gemini Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_GROQ",
        "Smoke Groq Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_SAMBANOVA",
        "Smoke SambaNova Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_MODEL_CEREBRAS",
        "Smoke Cerebras Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_NIM_MODELS",
        "Smoke NIM Models",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "CLAUDEY_SMOKE_NIM_EXTRA_MODELS",
