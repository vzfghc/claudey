...
from claudey.providers.runtime.config import has_provider_configuration
...
def smoke_env_default(key: str, default: str) -> str:
    """Return the env value or the caller-provided default (never None)."""

    value = _env_value(os.environ, key)
