...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "claudey.api.handlers.messages.MessagesHandler",
    ...
    CapabilityContract(
        ...
        "claudey.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "claudey.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "claudey.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "claudey.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "claudey.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "claudey.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "claudey.core.anthropic.thinking",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "claudey.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "claudey.api.optimization_handlers",
    ...
    CapabilityContract(
        ...
        "claudey.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "claudey.config.settings.Settings",
        "process env, user env file, repo env file, CLAUDEY_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "claudey.config.settings.Settings",
        "retired ENABLE_MODEL_THINKING or tier override in an claudey-owned dotenv",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "claudey.providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "claudey.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "claudey.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "claudey.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "claudey.messaging.workflow.MessagingWorkflow",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "claudey.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "claudey.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "claudey.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "claudey.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "codex_cli_drop_in",
        "drop_in_codex_replacement",
        "claudey.cli.launchers.codex",
        "Codex CLI binary and claudey provider env",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "claudey.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and Claudey child-process environment",
        "Anthropic Messages provider with an claudey-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "claudey.providers.runtime and claudey.messaging.platforms.factory",
