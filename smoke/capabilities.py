...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "process env, user env file, repo env file, HANS_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "claudey.config.settings.Settings",
        "retired ENABLE_MODEL_THINKING or tier override in an hans-owned dotenv",
    ...
    CapabilityContract(
        ...
        "Codex CLI binary and hans provider env",
    ...
    CapabilityContract(
        ...
        "Anthropic Messages provider with an hans-scoped live model catalog",
